...
public class IntegrationtestsConstants {
	...
	public static final String HTTPS_LOCALHOST_1443_SERVER_MEMBER_LOGIN_NEXT_SERVER_MEMBER_USER = "https://localhost:1443/angulartest/member/login?next=/angulartest/member/user";
	public static final String LOCAL_SERVER_URI = "http://localhost:8080/angulartest";
	public static final String LOGIN_BUTTON = ".btn";
